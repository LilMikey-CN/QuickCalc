...
- **现金:** 当前钱箱余额 − 上午系统现金 − 当前系统现金 − 昨日留存 + 配送现金 + 多找客人现金 + 其他支出 = 现金差额. The result shows the signed difference (drawer balance minus expected cash), with the expected balance and drawer balance shown separately. Positive means the drawer has extra cash; negative means it is short.
